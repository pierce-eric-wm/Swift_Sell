    ...
    <div class="topbar">
        <div class="casingnav">
            <ul class="navbar">
                ...
                <p class="locationlink" style="margin-left: 10px;"><a href="Home.php">Phoenix, Az <span
                            class="glyphicon glyphicon-map-marker"> </span> </a></p>
                ...
                <div class="col-lg-12">
                    <div class="well">
                        <form method="post" name="signUp" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="cardNumber">Card Number</label>
                                <input class="button" type="number" name="cardNumber"
                            ...
                            <div class="form-group">
                                <label for="confirmPassword">Confirm Password</label>
                                <input class="button" type="password" name="confirmPassword"
                                       placeholder="Your Password ..."/>


                            </div>
                            <button type="submit" name="signUp" value="1" class="signupbutton" style="width:100px;">Sign
                                Up
                            </button>

                            <p style="float:right; margin-top:18px;">Already a member?<a href="signIn.php"> Sign In!</a>
                            </p>
                        </form>
                    </div>
                </div>
